...
"Copyright &copy; 2011-YYYY The MMTCoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About MMTCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>MMTCoin</b> version", 0));
